...
geoservice = GeoSvc(
  "GeoSvc",
  detectors = ['MYBASEDIR/install/share/compact/SCEPCAL.xml']
)
...
podiooutput = PodioOutput("PodioOutput", filename = "scepcalsim_PDGMYPARTICLE_EMYENERGYGeV_jobMYJOBID.root")
